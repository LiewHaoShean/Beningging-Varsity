...
const CourseShortsScreen = () => {
  const video = require("../assets/investVideo.MP4");
    ...
    <>
      <div className="flex flex-row border-t-2 border-black">
        <div className="flex flex-col items-center justify-center">
          <div className="w-full h-max-[66.67%] bg-[#383838] px-[22rem]">
            <div className="h-[70vh] w-[25vw] flex items-center justify-center py-1">
              <ReactPlayer
                url={video}
                playing={true}
                controls={true}
...
export default CourseShortsScreen;
