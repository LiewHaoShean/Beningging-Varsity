...
const courses = [
    {
      ...
      description: 'The most complete course available on Product Management. 13+ hours of videos, activities...',
      price: 'RM 69',
    ...
    },
    {
      ...
      description: 'Unlock the secrets of the financial world and become a savvy investor with our comprehensive course on financial investments...',
      price: 'RM 109',
      lecturer: 'Hor Yuan Li',
      lecturerImg: lecturer
    },
    {
      ...
      description: 'Learn the basics of financial investing, from stocks to bonds, and build a solid foundation for your financial future...',
      price: 'RM 119',
      lecturer: 'Hor Yuan Li',
      lecturerImg: lecturer
    },
    {
      ...
      description: 'Learn how to optimize your investment portfolio by balancing risk and reward, mastering diversification, and leveraging market opportunities effectively...',
      price: 'RM 129',
      lecturer: 'Hor Yuan Li',
      lecturerImg: lecturer
    },
    {
      ...
      description: 'Explore the lucrative world of real estate investment, covering property valuation, rental income strategies, and wealth-building through real estate assets...',
      price: 'RM 59',
      lecturer: 'Hor Yuan Li',
      lecturerImg: lecturer
    },
    {
      ...
      description: 'Gain a competitive edge in the stock market with proven trading techniques, technical analysis tools, and insights into market psychology for successful trading outcomes...',
      price: 'RM 149',
      lecturer: 'Hor Yuan Li',
      lecturerImg: lecturer
    }
        ...
        <div className="w-full bg-white h-fit flex justify-center content-center pb-6">
            <ul className="h-fit w-10/12 bg-white grid grid-rows-2 grid-cols-3 gap-4">
                {courses.map((course, index) => (
                    <li className="relative border-2 border-none h-full bg-white outline-none shadow-2xl shadow-black-500/40 flex-column"
                        key={index} onMouseEnter={() => handleCardHover(index)} onMouseLeave={handleCardLeave}
                    >
                        <div className="h-72">
                            <img src={course.image} className="object-contain overflow-hidden h-full w-full"/>
                        </div>
                        <div className="flex">
                            <div className="h-20 w-full relative">
                                <img src={course.lecturerImg} className="object-fit overflow-hidden rounded-full h-20 w-20 absolute bottom-10 left-4 shadow-xl shadow-black-500/40"></img>
                                <h1 className="absolute top-1 right-2 font-semibold italic text-lg">{course.lecturer}</h1>
                            </div>
                        ...
                        <div className="border-b-2 border-gray-300 ">
                            <div className="h-32 px-4 py-2 flex flex-wrap content-center justify-center">
                                <h1 className="text-center italic font-bold text-3xl">{course.title}</h1>
                            </div>
                            <div className="h-24 p-4 flex flex-wrap content-center justify-center">
                                <h2 className="text-center italic font-bold text-medium ">{course.description}<a href="#" className="text-red-700 font-extrabold">Read More</a></h2>
                            </div> 
                        </div>
                        <div className="h-20 flex flex-wrap flex-row justify-between content-center text-center">
                            ...
                            <h1 className="h-14 mr-12 mt-3 italic text-3xl font-semibold text-red-700">{course.price}</h1>
                        </div>
                        {hoveredCard === index && (
                            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-75">
                                <video className="max-w-full max-h-full" src={course.video} autoPlay muted loop controls />
                            </div>
                        )}
                    </li>
                ))}
